...
const About = () => {
  return (
    <div id="about" className='w-full flex flex-col lg:flex-row px-8 md:px-10 gap-20 lg:py-20'>
      ...
      <div className='w-full flex flex-col'>
        ...
        <p className='text-lg text-black dark:text-gray-400 leading-10'>
          Full-Stack Web Developer with the ability to learn and collaborate in rapidly changing environments and compositions.
